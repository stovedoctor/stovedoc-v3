...
<div class="section-wrapper" style="margin-top: 0; padding-top: 5px;">
  ...
  <div class="intro-block" style="margin-top: 15px;">
    ...
    <div class="bg-tool-card" onclick="document.getElementById('zoom-extraction').showModal()">
        <img src="handtoolsbits-lg.webp" class="card-bg-image" alt="Background Hardware">
        <div class="bg-tool-content">
            ...
            <ul style="list-style: none; padding: 0; margin-top: 15px; line-height: 1.8;">
                ...
                <li>✔️ <strong>Nut Drivers:</strong> 1/4", 5/16", 11/32", 3/8", 7/16", 1/2" (SAE) + Metric.</li>
...
<section class="section-wrapper">
    <div class="bg-tool-card" onclick="document.getElementById('zoom-vitals').showModal()">
        <img src="electrical-lg.webp" class="card-bg-image" alt="Background Vitals">
        <div class="bg-tool-content">
            <h3 style="color:var(--flame); border-bottom: 1px solid #444; padding-bottom: 10px;">2. Vitals & Diagnostics (EKG)</h3>
            <p style="font-size: 0.9rem; color: #ccc; margin-bottom: 15px;">Critical for when a <strong>gas fireplace pilot will not light</strong> or your pellet stove 'logic' stops communicating.</p>
            <ul style="list-style: none; padding: 0; line-height: 1.8;">
                ...
                <li>✔️ <strong>High-Temp Spares:</strong> A staged tray of butt connectors and spade terminals for "transplants."</li>
                <li>✔️ <strong>Non-Contact Probe:</strong> (Optional) Nice for a quick safety "pulse" check.</li>
            </ul>
        </div>
...
<section class="section-wrapper">
    <div class="bg-tool-card" onclick="document.getElementById('zoom-support').showModal()">
        <img src="brush-lg.webp" class="card-bg-image" alt="Background Support">
        <div class="bg-tool-content">
            ...
            <ul style="list-style: none; padding: 0; line-height: 1.8;">
                ...
                <li>✔️ <strong>The Uplink:</strong> Strong 5G or Wi-Fi signal at the hearth so the Doctor has a clear view.</li>
            </ul>
        </div>
