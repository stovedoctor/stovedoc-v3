...
<div class="section-wrapper" style="margin-top: 0; padding-top: 5px;">
  ...
  <section class="section-wrapper">
    <div class="grid-2">
        <div class="info-card">
            <h3 style="text-align: left; border-bottom: 1px solid var(--flame); padding-bottom: 10px;">1. Hardware Extraction</h3>
            <ul style="list-style: none; padding: 0; margin-top: 15px; line-height: 1.6;">
                ...
                <li>✔️ <strong>Surgical Forceps:</strong> Channel Locks and needle-nose.</li>
        ...
        <div style="height: 100%; width: 100%; position: relative;">
            <img src="handtoolsbits-lg.webp" alt="Hardware Extraction Tools" class="thumb-fit zoom-clickable" onclick="this.nextElementSibling.showModal()" style="width: 100%; height: 100%; object-fit: cover; border-radius: 8px; box-shadow: 0 10px 30px rgba(0,0,0,0.6);">
            <dialog class="zoom-modal" onclick="this.close()"><img src="handtoolsbits-lg.webp" alt="Zoomed Hardware Tools"></dialog>
        </div>
    </div>
</section>
...
<section class="section-wrapper">
    <div class="grid-2">
        <div class="info-card">
            <h3 style="text-align: left; border-bottom: 1px solid var(--flame); padding-bottom: 10px;">2. Vitals & Diagnostics (EKG)</h3>
            ...
            <ul style="list-style: none; padding: 0; line-height: 1.8;">
                <li>✔️ <strong>Digital Multimeter:</strong> Your stethoscope for <strong>thermopile testing</strong> and millivolt readings. (True RMS preferred).</li>
        ...
        <div style="height: 100%; width: 100%; position: relative;">
            <img src="electrical-lg.webp" alt="Vitals and Diagnostics Tools" class="thumb-fit zoom-clickable" onclick="this.nextElementSibling.showModal()" style="width: 100%; height: 100%; object-fit: cover; border-radius: 8px; box-shadow: 0 10px 30px rgba(0,0,0,0.6);">
            <dialog class="zoom-modal" onclick="this.close()"><img src="electrical-lg.webp" alt="Zoomed Electrical Tools"></dialog>
        </div>
    </div>
</section>
...
<section class="section-wrapper">
    <div class="grid-2">
        <div class="info-card">
            <h3 style="text-align: left; border-bottom: 1px solid var(--flame); padding-bottom: 10px;">3. Surgical Support Gear</h3>
        ...
        <div style="height: 100%; width: 100%; position: relative;">
            <img src="brush-lg.webp" alt="Surgical Support Gear" class="thumb-fit zoom-clickable" onclick="this.nextElementSibling.showModal()" style="width: 100%; height: 100%; object-fit: cover; border-radius: 8px; box-shadow: 0 10px 30px rgba(0,0,0,0.6);">
            <dialog class="zoom-modal" onclick="this.close()"><img src="brush-lg.webp" alt="Zoomed Support Gear"></dialog>
        </div>
    </div>
</section>
